            ...
            <div class="container mt-5">
                <div class="row">
                    <div
                        ...
                        <div id="timestamp" class="text-center mt-3"></div>
                        <div class="simple-footer">
                            Copyright &copy; Sunil Adhikari <span id="year"></span>
                        </div>
                    </div>
                </div>
            </div>
...
{{-- 
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            if (timestampElement) {
                timestampElement.textContent = `Current Date and Time: ${getCurrentTimestamp()}`;
            }
